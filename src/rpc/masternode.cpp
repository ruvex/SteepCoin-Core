...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner steepcoin address\n"
            "  payee          - Print the masternode payout steepcoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting steepcoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "steepcoin",               "masternode",             &masternode,             true,  {} },
    { "steepcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "steepcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "steepcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
