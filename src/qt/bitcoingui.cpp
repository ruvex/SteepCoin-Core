...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about steepcoin Core"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to steepcoin network", "", count));
    } else {
...
{
    QString strTitle = tr("steepcoin Core"); // default title
    ...
    // Append title to "steepcoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
