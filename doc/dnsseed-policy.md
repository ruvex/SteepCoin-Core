...
steepcoin Core attempts to minimize the level of trust in DNS seeds,
...
See also
----------
- [steepcoin-seeder](https://github.com/nightlysteepcoin/steepcoin-seeder) is a reference implementation of a DNS seed.
