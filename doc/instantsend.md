...
This mechanism has been integrated into Bitcore-Node-steepcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ruvex/insight-api-steepcoin#web-socket-api](https://github.com/ruvex/insight-api-steepcoin#web-socket-api)
* API: [https://github.com/ruvex/insight-api-steepcoin#instantsend-transactions](https://github.com/ruvex/insight-api-steepcoin#instantsend-transactions)
