Cross-compiliation of steepcoin Core
===============================

steepcoin Core can be cross-compiled on Linux to all other supported host systems. This is done by changing
the `HOST` parameter when building the dependencies and then specifying another `--prefix` directory when building steepcoin.
...
When building steepcoin Core, use
