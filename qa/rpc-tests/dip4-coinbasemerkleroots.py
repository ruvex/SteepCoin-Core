#!/usr/bin/env python3
# Copyright (c) 2015-2018 The steepcoin Core developers
...
class LLMQCoinbaseCommitmentsTest(steepcoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as steepcoinTestFramework doesn't support this atm)
