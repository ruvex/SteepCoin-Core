...
official/supported Docker Images found at https://hub.docker.com/r/ruvex/steepcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/ruvex/steepcoind-develop/ when changing the above text**